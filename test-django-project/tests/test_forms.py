...
@pytest.mark.parametrize('value',
                         CPFField.invalid_values + (
                             '12345678901', '12345678901!@', '1234567890112312312'
                         ))
...
@pytest.mark.parametrize('value', CNPJField.invalid_values + ('12345678901234', '1234567890112312312', '      '))
